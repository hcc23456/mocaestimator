    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                {{--validation messages--}}
                <div class="container">
                    @if(session()->has('recaptchaFail'))
                        <div class="alert alert-danger col-sm-5">
                            {!! session()->get('recaptchaFail') !!}
                        </div>
                    @endif
                    ...
                    @if(session()->has('confirmCodeFailure'))
                        <div class="alert alert-danger col-sm-5">
                            {!! session()->get('confirmCodeFailure') !!}
                        </div>
                    @endif

                    @if(session()->has('userFindFailure'))
                        <div class="alert alert-danger col-sm-5">
                            {!! session()->get('userFindFailure') !!}
                        </div>
                    @endif
